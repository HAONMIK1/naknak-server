...
public class ReviewService {
    ...
    public ReviewResponse create(Long userId, Long restaurantId, ReviewCreateRequest request) {
        ...
        scoreEarnPublisher.publish(new ScoreEarnEvent(userId, ScoreReason.REVIEW_CREATE, review.getId()));
        if (imageUrls != null && !imageUrls.isEmpty()) {
            scoreEarnPublisher.publish(new ScoreEarnEvent(userId, ScoreReason.REVIEW_PHOTO, review.getId()));
        }
